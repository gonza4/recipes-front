...
// CATEGORIAS
        ...
        if (dietLabels.length==0&&healthLabels.length==0) {
            document.getElementById("lblCategorias").innerHTML = 'Se debe seleccionar al menos una categoria';
            console.log("*********************RETURN DE CATEGORIAS***********************");
            document.getElementById("btnGuardar").disabled=false;
           return;
        }else{
...
//PROCEDIMIENTO        
        ...
        if (link.style.display == "block") {
            if (typeof(formLinkProcedimiento) == "undefined"  || formLinkProcedimiento==""){
document.getElementById("btnGuardar").disabled=false;
  console.log("*********************RETURN DE LINK***********************");
    return;
 ...
 if (typeof(formTextProcedimiento) == "undefined"  || formTextProcedimiento==""){
document.getElementById("btnGuardar").disabled=false;
  console.log("******************RETURN DE PROCEDIMIENTO******************");
    return;
...
//CALORIAS/PORCIONES        
        ...
        if (typeof(formCalorias) == "undefined"  || formCalorias=="" || typeof(formPorciones) == "undefined"  || formPorciones==""){
document.getElementById("btnGuardar").disabled=false;
  console.log("******************RETURN DE CALORIAS/PORCIONES******************");
    return;
...
console.log("4 hago el envio por post");
        $http.post(
            ...
            $("#modalNuevaReceta").on('hide.bs.modal', function(){
              //  console.log("valor del link cuando se cierra: "+formLinkProcedimiento);
